...
from bridge_attention import MLPResNetBlockPro, ProprioProjector, ActionHead
...
class Qwen3VLA(Qwen3VLPreTrainedModel):
    ...
    def __init__(self, config):
        ...
        self.action_head = ActionHead(
            ...
            num_task_tokens=self.num_task_embeddings,
            action_chunk_len=action_chunk_len,
        )

    def _init_weights(self, module):
        if isinstance(module, ActionHead):
            module.init_hidden_state()
        elif isinstance(module, MLPResNetBlockPro):
            module.initialize_gating_factor()
